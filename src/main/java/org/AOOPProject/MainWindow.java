...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        HomeButton = new ExactNavigationButton(this, new RealFileSystemPopulator("DownloadsButton", "~"));
        HomeButton.setText("Home");
        HomeButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        HomeButton.setMaximumSize(new java.awt.Dimension(10000, 31));
        HomeButton.setMinimumSize(new java.awt.Dimension(10000, 31));
        HomeButton.setName("HomeButton"); // NOI18N
        typesPanel.add(HomeButton);

        DesktopButton = new ExactNavigationButton(this, new RealFileSystemPopulator("DownloadsButton", "~/Desktop"));
        DesktopButton.setText("Desktop");
        DesktopButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        DesktopButton.setMaximumSize(new java.awt.Dimension(10000, 31));
        DesktopButton.setMinimumSize(new java.awt.Dimension(10000, 31));
        DesktopButton.setName("DesktopButton"); // NOI18N
        DesktopButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DesktopButtonActionPerformed(evt);
            }
        });
        typesPanel.add(DesktopButton);

        DocumentsButton = new ExactNavigationButton(this,
                new VirtualFileSystemPopulator("Documents", GlobFileFilter.class,
                        new String[] { "~/Downloads/*.doc*", "~/Downloads/*.ppt*", "~/Downloads/*.xls*",
                                "~/Downloads/*.pdf", "~/Downloads/*document*", "~/Documents/*" }));
        DocumentsButton.setText("Documents");
        DocumentsButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        DocumentsButton.setMaximumSize(new java.awt.Dimension(10000, 31));
        DocumentsButton.setMinimumSize(new java.awt.Dimension(10000, 31));
        DocumentsButton.setName("DocumentsButton"); // NOI18N
        typesPanel.add(DocumentsButton);

        DownloadsButton = new ExactNavigationButton(this,
                new RealFileSystemPopulator("DownloadsButton", "~/Downloads"));
        DownloadsButton.setText("Downloads");
        DownloadsButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        DownloadsButton.setMaximumSize(new java.awt.Dimension(10000, 31));
        DownloadsButton.setMinimumSize(new java.awt.Dimension(10000, 31));
        DownloadsButton.setName("DownloadsButton"); // NOI18N
        typesPanel.add(DownloadsButton);

        PicturesButton = new ExactNavigationButton(this,
                new VirtualFileSystemPopulator("Pictures", GlobFileFilter.class, new String[] { "~/Downloads/*.jpeg",
                        "~/Downloads/*.jpg", "~/Downloads/*.png", "~/Downloads/*image*", "~/Pictures/*" }));
        PicturesButton.setText("Pictures");
        PicturesButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        PicturesButton.setMaximumSize(new java.awt.Dimension(10000, 31));
        PicturesButton.setMinimumSize(new java.awt.Dimension(10000, 31));
        PicturesButton.setName("PicturesButton"); // NOI18N
        typesPanel.add(PicturesButton);
