...
public class MainWindow extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		DesktopButton = new ExactNavigationButton(this,
				new RealFileSystemPopulator("DownloadsButton", "~/Desktop"));
		...
		DocumentsButton = new ExactNavigationButton(this,
				new VirtualFileSystemPopulator("Documents", GlobFileFilter.class,
						new String[] { "~/Downloads/*.doc*", "~/Downloads/*.ppt*",
								"~/Downloads/*.xls*",
								"~/Downloads/*.pdf", "~/Downloads/*document*",
								"~/Documents/*" }));
		...
		PicturesButton = new ExactNavigationButton(this,
				new VirtualFileSystemPopulator("Pictures", GlobFileFilter.class,
						new String[] { "~/Downloads/*.jpeg",
								"~/Downloads/*.jpg", "~/Downloads/*.png",
								"~/Downloads/*image*", "~/Pictures/*" }));
