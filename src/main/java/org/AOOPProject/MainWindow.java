...
>>>>>>> fb16cfb8ae856db0b34b45e291af6b2d454a68a8
...
>>>>>>> fb16cfb8ae856db0b34b45e291af6b2d454a68a8
        ...
        Pictures.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                PicturesAncestorAdded(evt);
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
                PicturesAncestorMoved(evt);
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
                PicturesAncestorRemoved(evt);
            }
        });
...
<<<<<<< HEAD
    protected void PicturesAncestorRemoved(AncestorEvent evt) {
    }

    protected void PicturesAncestorMoved(AncestorEvent evt) {
    }
    ...
    private void typeButtonActionPerformed(java.awt.event.ActionEvent evt, String path) {// GEN-FIRST:event_typeButtonActionPerformed
        // TODO add your handling code here:
        ...
        disp.bridge.setFirstColumnDirectory(
                new VirtualFileSystemPopulator(disp, name, GlobFileFilter.class,
                        new String[] { path }));
    ...
    private void typeButtonAncestorAdded(javax.swing.event.AncestorEvent evt) {// GEN-FIRST:event_DownloadsAncestorAdded
    }
    ...
    private void PicturesAncestorAdded(javax.swing.event.AncestorEvent evt) {// GEN-FIRST:event_PicturesAncestorAdded
        // TODO add your handling code here:
    }// GEN-LAST:event_PicturesAncestorAdded
    ...
    private void PicturesActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        disp.bridge.setFirstColumnDirectory(
                new VirtualFileSystemPopulator(disp, "Documents", GlobFileFilter.class,
...
=======
	...
	public JPanel getLabelsNavigationPanel() {
		return labelsNavigationPanel;
	}
