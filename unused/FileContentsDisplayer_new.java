...
// public FileContentsDisplayer(String[] fileSearchPathsRegex, String[]
// fileSearchPathsGlob) {
// populator = new FileSystemPopulator(fileSearchPathsRegex,
// fileSearchPathsGlob);
// currentFilePath = new File[0];
// initComponents();
// }
...
// switch (mode) {
// case GLOB:
// populator = new FileSystemPopulator(new String[0],
// fileSearchPathsUnspecified);
// break;
// case REGEX:
// populator = new FileSystemPopulator(fileSearchPathsUnspecified, new
// String[0]);
// break;
// default:
// populator = new FileSystemPopulator(new String[0], new String[0]);
...
// // (currentFilePath[currentFilePath.length - 1]) should be shown in the
// jLists.
// // TODO: Make a variable (setting) to store the maximum number of columns up
// the
...
// public FileSystemPopulator(String[] searchPathsRegex, String[]
// searchPathsGlob) {
...
// public <T extends FileFilter> void populate(int depth, String[] searchPath,
// File currentFile,
// Class<T> filterType) {
// try {
...
// }
// } else
// throw new RuntimeException("Depth could not exceed the length of
// searchPath");
// }

// private <T extends FileFilter> void updateS(String[] paths, Class<T>
// filterType) {
